...
public class homePageTC3 extends dockerWithChrome{
	...
	/*
	 * @Test(enabled = true) public void tc001_Login() throws InterruptedException {
	 * homePage hmpg = new homePage(driver); hmpg.clickContinueShoppingButton();
	 * hmpg.clickHeaderDropDownSignIn(); hmpg.enterMobileNoOrEmailAndContinue();
	 * hmpg.enterPasswordAndClickOnSignIn(); hmpg.verifyUserIsLoggedIn(); }
	 */
